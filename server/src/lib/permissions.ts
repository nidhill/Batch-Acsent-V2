...
export const PERMISSIONS = {
    MANAGE_USERS: [ROLES.ADMIN, ROLES.SUB_ADMIN],
    MANAGE_SCHOOLS_COURSES: [ROLES.ADMIN, ROLES.SUB_ADMIN],
    VIEW_ACTIVITY_LOGS: [ROLES.ADMIN, ROLES.SUB_ADMIN, ROLES.CEO, ROLES.BUSINESS_HEAD],
