...
export const PERMISSIONS = {
    ...
    LINK_STUDENT: [ROLES.ADMIN, ROLES.CEO, ROLES.SHO, ROLES.SSHO, ROLES.ACADEMIC_LEAD, ROLES.SALES_HEAD],
    CALL_STUDENT: [ROLES.ADMIN, ROLES.CEO, ROLES.SHO, ROLES.SSHO, ROLES.ACADEMIC_LEAD, ROLES.SALES_HEAD],
